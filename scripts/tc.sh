...
tc filter add dev $wlan parent 1: handle 20 fw classid 1:1 # data
tc filter add dev $wlan parent 1: handle 21 fw classid 1:1 # fec
...
tc filter add dev $wlan parent 1: handle 30 fw classid 1:20 # data
tc filter add dev $wlan parent 1: handle 31 fw classid 1:20 # fec
...
tc filter add dev $wlan parent 101: handle 20 fw classid 101:1 # data
tc filter add dev $wlan parent 101: handle 21 fw classid 101:2 # fec
...
tc filter add dev $wlan parent 103: handle 30 fw classid 103:1 # data
tc filter add dev $wlan parent 103: handle 31 fw classid 103:2 # fec
